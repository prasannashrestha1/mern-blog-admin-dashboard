  ...
  return (
    <div className="min-h-screen pt-20">
      <div className="p-4 md:p-6 flex max-w-6xl mx-auto flex-col md:flex-row md:items-center gap-4">
        ...
        {/* right Container */}
        <div className="flex-1">
          <form className=" flex flex-col gap-5 text-md md:text-lg font-medium">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button className="bg-red-50 rounded-full bg-gradient-to-r from-purple-500 via-red-500 to-yellow-500 hover:bg-gradient-to-l p-[2px] hover:shadow-xl hover:shadow-purple-600/10 group">
                <div className="bg-white gap-2 items-center justify-center rounded-full p-1.5 transition ease-in-out duration-900 group-hover:bg-gradient-to-br group-hover:from-gray-100 group-hover:to-gray-100 flex flex-row">
